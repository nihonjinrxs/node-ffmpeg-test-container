...
```{bash}
docker-compose build --build-arg VERSION=`cat VERSION` test_worker
```

## Running the container (with example output)
```{text}
docker-compose up
Creating network "node-ffmpeg-test-container_default" with the default driver
Creating node-ffmpeg-test-container_test_worker_1 ... done
Attaching to node-ffmpeg-test-container_test_worker_1
test_worker_1  | [2018-08-14-16:36:58.989+0000] Started container version 1.0.0... checking things out...
...
test_worker_1  | 6.2.0
test_worker_1  | [2018-08-14-16:36:59.269+0000] Finished checking things out.
test_worker_1  |
test_worker_1  | [2018-08-14-16:36:59.271+0000] Simulating running process (2 tasks of 10 - 30 sec each).
test_worker_1  | [2018-08-14-16:36:59.272+0000] Executing task 1...
test_worker_1  | [2018-08-14-16:37:15.276+0000] Task 1 completed in 16 seconds.
test_worker_1  | [2018-08-14-16:37:15.278+0000] Executing task 2...
test_worker_1  | [2018-08-14-16:37:44.247+0000] Task 2 completed in 29 seconds.
test_worker_1  |
test_worker_1  | [2018-08-14-16:37:44.248+0000] Job completed in 45 seconds.
